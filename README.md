...
- [dbt BigQuery Demo](#dbt-bigquery-demo)
  ...
  - [Working Environment Setup](#working-environment-setup)
    ...
    - [2. Install dbt-core and dbt-bigquery](#2-install-dbt-core-and-dbt-bigquery)
    - [3. Verify Installation](#3-verify-installation)
  - [Project Configuration](#project-configuration)
    - [1. Update profiles.yml](#1-update-profilesyml)
    - [2. Update dbt\_project.yml (if needed)](#2-update-dbt_projectyml-if-needed)
  - [Running Your First dbt Project](#running-your-first-dbt-project)
    - [1. Test Your Connection](#1-test-your-connection)
    - [2. Install Dependencies (if any)](#2-install-dependencies-if-any)
    - [3. Run dbt Models](#3-run-dbt-models)
    - [4. Test Your Models](#4-test-your-models)
